...
net_socket_t* net_socket_accept(net_socket_t* listen_sock, sockaddr_in_t* addr_out, uint64_t timeout_ms);
int net_socket_tcp_recv(net_socket_t* sock, void* buf, size_t len, uint64_t timeout_ms);
