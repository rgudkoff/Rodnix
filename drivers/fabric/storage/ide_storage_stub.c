...
static int ide_storage_match_score(fabric_device_t* dev)
{
    return ide_storage_probe(dev) ? FABRIC_MATCH_GENERIC : FABRIC_MATCH_NONE;
}

static const fabric_property_t ide_storage_match_properties[] = {
    { .key = "bus", .type = FABRIC_PROP_STR, .value.str = "pci" },
    { .key = "class-code", .type = FABRIC_PROP_U32, .value.u32 = 0x01u },
    { .key = "subclass", .type = FABRIC_PROP_U32, .value.u32 = 0x01u },
};
...
static fabric_driver_t g_driver = {
    ...
    .match_properties = ide_storage_match_properties,
    .match_property_count = 3,
    .match_score = ide_storage_match_score,
