# XNU Crosswalk для RodNIX

Документ фиксирует соответствие между подсистемами RodNIX и локальным деревом
XNU (`/Users/romangudkov/dev/xnu`) для практического проектирования структуры
файлов и границ модулей.

## Что изучено в XNU (локально)
...
## Crosswalk: RodNIX -> XNU

| Подсистема RodNIX | Текущее место | XNU референс | Целевое место RodNIX |
| --- | --- | --- | --- |
