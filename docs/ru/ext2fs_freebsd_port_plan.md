...
- [ ] Реализовать чтение/обновление block bitmap.
- [ ] Реализовать выбор группы и поиск свободного блока.
- [ ] Обновлять `free_blocks_count` в group descriptor и superblock.

### Этап 2: Рост файла и запись

- [ ] Расширить `ext2_writeback_file`:
...
- [ ] Обновлять размер inode на диске.

### Этап 3: truncate/ftruncate

- [ ] Поддержать увеличение и уменьшение файла.
- [ ] При уменьшении освобождать блоки и корректировать счетчики.
